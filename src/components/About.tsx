        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-6 text-text-light leading-relaxed">
              We're a family-run bookkeeping business with over 8 years of experience helping individuals and companies keep their finances organised, accurate, and stress-free. From the very beginning, our focus has been on building long-term relationships based on trust, reliability, and personal service.
            </p>
            <p className="text-lg mb-6 text-text-light leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <Card className="p-6 text-center shadow-soft border border-border/50">
                ...
                <h3 className="font-semibold mb-2 text-foreground">8+ Years Experience</h3>
